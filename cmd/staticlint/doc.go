/*
Линтер на основе golang.org/x/tools/go/analysis.

Данный инструмент объединяет в себе анализаторы на основе passes, staticcheck, securego, go-critic.
Дополнительно, в линтер включен свой анализатор.

Usage:

	staticlint [flags] [path ...]
...
The flags are:
	  ...
	  -SA4013
	        Negating a boolean twice (!!b) is the   -me as writing b. This is either redundant, or a typo.
	  ...
	  -SA4019
	        Multiple, identical build constraints in the -me file
	  ...
	  -sortslice
	    	checks for calls to sort.
		Slice that do not use a slice type as first argument
	  ...
	  -exitcheck
	    	check os.Exit() in func main() of the package main
*/
package main
